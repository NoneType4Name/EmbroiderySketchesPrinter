...
class DrawSketch:
    ...
    def SixthElement(self, bg=(0, 0, 0, 0)):
        ...
        for n in range(9):
            sketch.line((
                (self.printer.mmTOpx(self.techno_padding) + (xy2[1][0] - xy2[0][0]) / 2, self.printer.mmTOpx(10 + 6 * n) + xy0[0][1] + pad * n),
                (self.printer.mmTOpx(self.techno_padding) + (xy2[1][0] - xy2[0][0]) / 2, self.printer.mmTOpx(10 + 6 * (n + 1)) + xy0[0][1] + pad * n)), self.sketch_lines_color, self.printer.mmTOpx(1))
            sketch.line((
                (self.printer.mmTOpx(self.techno_padding - 3) + (xy2[1][0] - xy2[0][0]) / 2, self.printer.mmTOpx(10 + 6 * (n + 1) - 3) + xy0[0][1] + pad * n),
                (self.printer.mmTOpx(self.techno_padding + 3) + (xy2[1][0] - xy2[0][0]) / 2, self.printer.mmTOpx(10 + 6 * (n + 1) - 3) + xy0[0][1] + pad * n)), self.sketch_lines_color, self.printer.mmTOpx(1))
        return image
